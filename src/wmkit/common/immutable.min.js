...
!(function(t, e) {
  ...
  function at(t) {
    ...
    if (((e = ++Rr), 1073741824 & Rr && (Rr = 0), jr)) Or.set(t, e);
      ...
      if (Ar) Object.defineProperty(t, Ur, {enumerable: !1, configurable: !1, writable: !1, value: e});
      else if (
  ...
  function Vt(t, e, r, n, i, o) {
    ...
    return s && t.array[u] === i
      ? t
      : (c(o), (a = Yt(t, e)), void 0 === i && u === a.array.length - 1 ? a.array.pop() : (a.array[u] = i), a);
  }
  function Yt(t, e) {
  ...
  function Xt(t, e, r) {
    ...
    f && ((u += f), (i += f), (s += f), (o += f));
    for (var c = Gt(o), p = Gt(s); p >= 1 << (a + pr); ) (h = new Ct(h && h.array.length ? [h] : [], n)), (a += pr);
    var v = t._tail,
