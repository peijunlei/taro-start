...
const serverInfo = '';
const controllerName = 'AppointmentGoodsController';
 ...
 *
 */
async function page(request: IPageRequestReq): Promise<AppointmentGoodsResponse> {
  let result = await sdk.post<AppointmentGoodsResponse>(
    '/appointment/goods/page',
...
/**
 */
export interface AppointmentGoodsInfoSimplePageRequest {
  /**
...
/**
 */
export interface BaseResponseAppointmentGoodsResponse {
  /**
   * 结果码
   */
  code: string;
  context?: AppointmentGoodsResponse;
  /**
   * 错误内容
   */
  errorData?: {
 ...
 * 内容
 */
export interface AppointmentGoodsResponse {
  page?: MicroServicePageAppointmentSaleGoodsVO;
  [k: string]: any;
}
/**
 * 预约抢购商品信息
 */
export interface MicroServicePageAppointmentSaleGoodsVO {
  /**
   * 具体数据内容
   */
  content?: AppointmentSaleGoodsVO[];
  empty?: boolean;
  first?: boolean;
  last?: boolean;
  /**
...
/**
 */
export interface AppointmentGoodsResponse1 {
  page?: MicroServicePageAppointmentSaleGoodsVO;
  [k: string]: any;
}
/**
 */
export interface MicroServicePageAppointmentSaleGoodsVO1 {
  /**
   * 具体数据内容
   */
  content?: AppointmentSaleGoodsVO[];
