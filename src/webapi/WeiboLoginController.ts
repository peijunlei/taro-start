...
const controllerName = 'WeiboLoginController';
 ...
 */
async function bind(
  weiboBindRequest: IBindWeiboBindRequestReq,
 ...
 * via the `definition` "WeiboBindRequest".
 */
export interface WeiboBindRequest {
  /**
   * 微博登录accessToken
   */
  accessToken?: string;
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "IBindWeiboBindRequestReq".
 */
export interface IBindWeiboBindRequestReq {
  /**
   * 微博登录accessToken
   */
  accessToken?: string;
