...
const controllerName = 'RecommendController';
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "IPageArticleRequestReq".
 */
export interface IPageArticleRequestReq {
  /**
   * 精准类型（全部、康友为商城、悦康送商城、地推；商城分为：APP、小程序、H5、PC官网......)
   */
  accurateType?: string;
