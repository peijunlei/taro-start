...
const controllerName = 'CustomerVerifiedH5Controller';
...
async function add(
  ...
  if (__DEV__) {
    if (isMock('CustomerVerifiedH5Controller', 'add')) {
      return Promise.resolve(
        require('./mock/CustomerVerifiedH5Controller.json')
          .CustomerVerifiedAddResponse || {},
      );
    }
  }

  let result = await sdk.post<CustomerVerifiedAddResponse>(
    '/customerverifiedH5/add',
...
): Promise<CustomerVerifiedModifyResponse> {
  let result = await sdk.put<CustomerVerifiedModifyResponse>(
    '/customerverifiedH5/modify',
...
async function myVerifiedInfo(): Promise<CustomerVerifiedByIdResponse> {
  let result = await sdk.get<CustomerVerifiedByIdResponse>(
    '/customerverifiedH5/myVerifiedInfo',
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "CustomerVerifiedModifyRequest".
 */
export interface CustomerVerifiedModifyRequest {
  /**
   * 人工审核备注
   */
  artificialRemake?: string;
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "BaseResponse«CustomerVerifiedModifyResponse»".
 */
export interface BaseResponseCustomerVerifiedModifyResponse {
  /**
   * 结果码
   */
  code: string;
  context?: CustomerVerifiedModifyResponse;
  /**
   * 消息内容
   */
  message?: string;
 ...
 * 内容
 */
export interface CustomerVerifiedModifyResponse {
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "CustomerVerifiedModifyResponse".
 */
export interface CustomerVerifiedModifyResponse1 {
  customerVerifiedVO?: CustomerVerifiedVO2;
  [k: string]: any;
}
/**
...
export interface CustomerVerifiedByIdResponse {
  customerVerifiedVO?: CustomerVerifiedVO3;
  [k: string]: any;
}
/**
 * 系统日志信息
 */
export interface CustomerVerifiedVO3 {
  /**
   * 人工审核备注
   */
  artificialRemake?: string;
