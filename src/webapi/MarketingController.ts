 ...
 *
 */
async function getMoreSuitsInfo(request: IGetMoreSuitsInfoRequestReq): Promise<MarketingMoreSuitsGoodInfoIdResponse> {
 ...
 *
 */
async function getMoreSuitsInfoForLogin(
  request: IGetMoreSuitsInfoRequestReq,
): Promise<MarketingMoreSuitsGoodInfoIdResponse> {
  let result = await sdk.post<MarketingMoreSuitsGoodInfoIdResponse>(
    '/marketing/login/getMoreSuitsInfo',
 ...
 *
 */
async function getMarketingById(marketingId: IGetMarketingByIdMarketingIdReq): Promise<MarketingForEndVO> {
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "IGetMoreSuitsInfoRequestReq".
 */
export interface IGetMoreSuitsInfoRequestReq {
  /**
   * 公司ID-SaaS
   */
  companyInfoIdAtSaaS?: number;
