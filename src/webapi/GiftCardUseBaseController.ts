...
// 查询礼品卡信息
async function queryGiftCard(request): Promise<unknown> {
  let result = await sdk.post('/goods/userGiftCard/useCard/queryGiftCard', {
    ...request,
  });
  return result.context;
}

async function queryGiftCardUnLogin(request): Promise<unknown> {
  let result = await sdk.post('/goods/userGiftCard/useCard/queryGiftCard/unLogin', {
    ...request,
  });
  return result.context;
}
...
// 查询商品信息
async function queryGoodsInfos(request): Promise<unknown> {
  let result = await sdk.post('/goods/userGiftCard/useCard/queryGoodsInfos', {
    ...request,
  });
  return result.context;
}

async function queryGoodsInfosUnLogin(request): Promise<unknown> {
  let result = await sdk.post('/goods/userGiftCard/useCard/queryGoodsInfos/unLogin', {
    ...request,
  });
  return result.context;
}
...
export default {
  ...
  queryGiftCardUnLogin,

  queryGoodsInfosUnLogin,
};
