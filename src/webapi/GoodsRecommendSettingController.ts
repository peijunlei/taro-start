...
const controllerName = 'GoodsRecommendSettingController';
 ...
 *
 */
async function getSetting(): Promise<GoodsRecommendSettingResponse> {
  let result = await sdk.get<GoodsRecommendSettingResponse>(
    '/goods/recommend/setting/get-setting',
 ...
 * via the `definition` "BaseResponse«GoodsRecommendSettingResponse»".
 */
export interface BaseResponseGoodsRecommendSettingResponse {
  /**
   * 结果码
   */
  code: string;
  context?: GoodsRecommendSettingResponse;
  /**
   * 消息内容
   */
  message?: string;
 ...
 * 内容
 */
export interface GoodsRecommendSettingResponse {
  goodsRecommendSettingVO?: GoodsRecommendSettingVO;
  [k: string]: any;
}
/**
 * 商品推荐配置信息
 */
export interface GoodsRecommendSettingVO {
  /**
   * 品牌列表
   */
  brands?: GoodsBrandVO[];
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "GoodsRecommendSettingResponse".
 */
export interface GoodsRecommendSettingResponse1 {
  goodsRecommendSettingVO?: GoodsRecommendSettingVO;
  [k: string]: any;
}
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "GoodsRecommendSettingVO".
 */
export interface GoodsRecommendSettingVO1 {
  /**
   * 品牌列表
   */
  brands?: GoodsBrandVO[];
