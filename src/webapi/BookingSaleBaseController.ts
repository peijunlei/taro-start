...
const controllerName = 'BookingSaleBaseController';
 ...
 *
 */
async function isInProgress(goodsInfoId: IIsInProgressGoodsInfoIdReq): Promise<BookingSaleIsInProgressResponse> {
  let result = await sdk.get<BookingSaleIsInProgressResponse>(
    '/bookingsale/{goodsInfoId}/isInProgress'.replace('{goodsInfoId}', goodsInfoId + ''),
...
async function isInProgressUnLogin(goodsInfoId: IIsInProgressGoodsInfoIdReq): Promise<BookingSaleIsInProgressResponse> {
  let result = await sdk.get<BookingSaleIsInProgressResponse>(
    '/bookingsale/unlogin/{goodsInfoId}/isInProgress'.replace('{goodsInfoId}', goodsInfoId + ''),
 ...
 * via the `definition` "IIsInProgressGoodsInfoIdReq".
 */
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "BaseResponse«BookingSaleByIdResponse»".
 */
export interface BaseResponseBookingSaleByIdResponse {
  /**
   * 结果码
   */
  code: string;
  context?: BookingSaleByIdResponse;
  /**
   * 错误内容
   */
  errorData?: {
 ...
 * 内容
 */
export interface BookingSaleByIdResponse {
  bookingSaleVO?: BookingSaleVO;
  [k: string]: any;
}
export interface BookingSaleIsInProgressResponse {
  bookingSaleVO?: BookingSaleVO;
  /**
   * 系统时间
   */
...
/**
 * This interface was referenced by `IgnoreType`'s JSON-Schema
 * via the `definition` "BookingSaleByIdResponse".
 */
export interface BookingSaleByIdResponse1 {
  bookingSaleVO?: BookingSaleVO;
  [k: string]: any;
}
/**
