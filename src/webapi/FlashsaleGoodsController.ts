 ...
 *
 */
async function isInProgress(goodsId: IIsInProgressGoodsIdReq): Promise<IsInProgressResp> {
...
async function isInProgressUnLogin(goodsId: IIsInProgressGoodsIdReq): Promise<IsInProgressResp> {
  let result = await sdk.get<IsInProgressResp>(
    '/flashsalebase/unlogin/{goodsId}/isInProgress'.replace('{goodsId}', goodsId + ''),
