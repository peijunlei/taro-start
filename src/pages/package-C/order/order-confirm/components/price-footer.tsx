...
import '@/pages/package-C/order/order-confirm/css/price-footer.less';
...
export default class PriceFooter extends Component<Partial<IPriceFooterProps>, T.IPriceFooterState> {
  ...
  render() {
    ...
    const {points = {}, localData = {}, price = {},giftCard2, isBookingSaleGoods, isCommit, giftCardType,loaded} = main;
    ...
    return isBookingSaleGoods ? (
      ...
      <View className="priceFooter">
        <View className="price-left">
          ...
          <Price price={!loaded ? 0 :  totalAmount} />
