...
export default class PriceCon extends Component<Partial<IPriceConProps>, T.IPriceConState> {
  ...
  render() {
    ...
    const { price = {}, points = {}, localData = {}, isBookingSaleGoods, stores = [], orderList,loaded, giftCard2 } = main;
    ...
    return (
      <View className="priceCon">
        <View className="order-confirm-store-item">
          ...
          <View className="store-item-right">
            <Text className="item-input-price">
              ¥
              {!loaded?0.00: this._calcOrderTotalAmount(
                hidePrice ? price.totalDeliveryPrice : price.totalPrice,
                couponTotalPrice,
                usePoint,
              )}
        ...
        {!hidePrice&& loaded && !isBookingSaleGoods && (
          <View className="order-confirm-store-item">
        ...
        {!orderList?.isVirtualGoods && !isCouponOrZhichongGoods && (
          <View className="order-confirm-store-item">
