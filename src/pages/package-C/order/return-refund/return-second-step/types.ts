...
export interface IMainReducer {
  ...
  selectedReturnState: IMainReturnGoodsStateListSet;

  returnGoodsStateList: IMainReturnGoodsStateListSet;

  selectedReturnReason: IMainSelectedReturnReason;

  selectedReturnWay: IMainSelectedReturnWay;

  selectReturnState: IMainSelectReturnState;
  ...
  isShowGoodsStateBox: boolean;
  isShowRefundReasonBox: boolean;
  isShowReturnWayBox: boolean;
  returnType: string;
}
...
export type IReturnRefundReasonState = {
  refundReasonBox?: boolean;
  returnWayBox?: boolean;
  goodsStateBox?: boolean;
};
...
export type IMainReturnGoodsStateListSet = IMainReturnGoodsStateList[];

export interface IMainReturnWayList {
  [k: string]: any;
}
export interface IMainReturnGoodsStateList {
  [k: string]: any;
}
export type IMainSelectedReturnReason = string;
export type IMainSelectedReturnWay = string;
export type IMainSelectReturnState = string;
