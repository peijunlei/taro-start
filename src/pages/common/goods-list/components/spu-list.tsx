            ...
            return (
              ...
              >
                <View className="img-box">
                  <Image src={goodsInfo.goodsInfoImg ? goodsInfo.goodsInfoImg : noDataIcon} className="goods-img" />
                  {/* 判断是否缺货 */}
                ...
                <View className="right-content">
                  ...
                  <View className="up-content">
                    ...
                    <View className="goods-title">
                      ...
                      <View className="title-view">
                        <Text className="words">
                          {goodsInfo.companyType == 0 && !main.request.storeId && <Text className="text">00000</Text>}
                    ...
                    <MarketingLabel
                      marketingLabels={!social && showFlag ? immutable.fromJS(goodsInfo.marketingLabels) : immutable.fromJS([])}
                  ...
                  <View className="down-content">
                    ...
                    <View className="goods-price">
                      ...
                      {!WMkit.isVirtualGoods(goodsType) && ((social && !main.isDistributor) || !social) && (
                        <Image
                          src={addIcon}
