            ...
            main.goods.map((item, index) => {
              ...
              return (
                <View
                  key={item.id}
                  className="spu-item"
                  onClick={() => activityAction.loadPages(item.goodsInfo, isAppointmentArry, isShowBooking)}
                >
                  ...
                  <View className="right-content">
                      ...
                      <View className="goods-title">
                        ...
                        <View className="title-view">
                          <Text className="words">
                            {item.goodsInfo.companyType == 0 && !main.request.storeId && (
                              <Text className="text">00000</Text>
                            )}
                    ...
                    <MarketingLabel
                      marketingLabels={!social && showFlag ? immutable.fromJS(item.goodsInfo.marketingLabels) : immutable.fromJS([])}
                      ...
                      <View className="goods-price">
                        ...
                        {!WMkit.isVirtualGoods(goodsType) && iscartCountFlag && (
                          <CartCount
                            ...
                            inventory={item.goodsInfo.stock}
                            getNum={(count, flag) => {
