  ...
  render() {
    ...
    return (
      <View className="navTools">
        ...
        <View
          className={selectItem === 1 ? 'tools-item select-item' : 'tools-item'}
        ...
        <View
          className={selectItem === 2 ? 'tools-item select-item' : 'tools-item'}
  ...
  _changeNav = async (v) => {
    ...
    if (v === 0) {
      ...
      if (!main.navToolsObj.commission) {
        //降序
        // goodsAction.commonChange('main.request.sortFlag', 8);
        goodsAction.commonChange([
          {
            paths: 'main.request.sortFlag',
            value: 8,
        ...
        //升序
        // goodsAction.commonChange('main.request.sortFlag', 9);
        goodsAction.commonChange([
          {
            paths: 'main.request.sortFlag',
            value: 9,
      ...
      // goodsAction.commonChange('main.navToolsObj.arrowFlag', false);
      // //佣金升序降序切换
      // goodsAction.commonChange('main.navToolsObj.commission', !main.navToolsObj.commission);
      // //价格置为升序
      // goodsAction.commonChange('main.navToolsObj.priceSoft', false);
    }
