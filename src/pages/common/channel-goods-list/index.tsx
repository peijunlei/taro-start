...
export default class TabbarChannelGoodsList extends Component<Partial<T.IProps>, any> {
  static defaultProps = {
    id: '',
    isTabbar: false,
  };
  ...
  render() {
    ...
    return (
      main && (
        <View className={`TabbarChannelGoodsList ${!imageShowType ? 'TabbarChannelGoodsList_big' : ''}`}
          style={{height:isTabbar? (__TARO_ENV==='h5'?`calc(100vh - 50px)`:'100vh'):'100vh'}}
        >
          {/* 搜索 */}
