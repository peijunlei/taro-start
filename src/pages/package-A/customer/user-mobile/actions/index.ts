...
import pagesPackageACustomerUserMobileMain from '../reducers/main';
  ...
  const actions = {
    ...
    async loadReducer() {
      reduxStore.registerReducer({
        pagesPackageACustomerUserMobileMain,
      });
    },
    ...
    async unloadReducer() {
      if (reduxStore.deregister) {
        reduxStore.deregister(['pagesPackageACustomerUserMobileMain']);
      } else {
