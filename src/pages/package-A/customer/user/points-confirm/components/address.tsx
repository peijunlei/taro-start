...
import {addressInfoOld} from '@/utils/location/area/area';
...
export default class Address extends Component<Partial<IAddressProps>, T.IAddressState> {
  ...
  render() {
    ...
    const phone = consigneeNumber
      ...
      : '';
    // const detail = addressInfoOld(address.provinceId, address.cityId, address.areaId) + address.deliveryAddress;
