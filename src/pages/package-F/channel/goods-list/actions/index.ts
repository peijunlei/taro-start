...
import channelGoodsListMain from '../reducers/main';
//更新购物车角标
...
export default (dispatch: Dispatch) => {
  const actions = {
    ...
    async init(params,props:any) {
      ...
      const { channelId=id, keywords, cateId, spreadFlag, brandIds, isGiftCard } = params;
      ...
      actions.goodsAction.commonChange([
        ...
        { paths: 'main.request.isGiftCard', value: isGiftCard === '1' ? true : false },
    ...
    async unloadReducer() {
      if (reduxStore.deregister) {
        reduxStore.deregister(['channelGoodsListMain']);
      } else {
