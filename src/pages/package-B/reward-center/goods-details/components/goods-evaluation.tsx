...
import {div} from '@/utils/priceFormat';
...
export default class GoodsEvaluation extends Component<Partial<IGoodsEvaluationProps>, T.IGoodsEvaluationState> {
  ...
  render() {
    let {
      ...
      main: {top3Evaluate, goodsDetail},
    } = this.props;
    //评价总数
    const evaluateConut = top3Evaluate.goodsEvaluateCountResponse
      ? top3Evaluate.goodsEvaluateCountResponse.evaluateConut
      : 0;
    let count;
    ...
    const praise = top3Evaluate.goodsEvaluateCountResponse ? top3Evaluate.goodsEvaluateCountResponse.praise : 100;
    return (
