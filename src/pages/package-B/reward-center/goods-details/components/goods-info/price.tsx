...
*/
  render() {
    ...
    //划线价
    let lineShowPrice = goodsDetail.goods ? this._originPriceInfo(goodsDetail.goods.linePrice, goodsInfo) : 0;
    return (
      <View className="reward-goods-detail-priceprice">
        <Text className="now-price">
          <Text className="unit">￥</Text>
          {toFixed2(Number(goodsInfo.marketPrice))}
        </Text>
      </View>
    );
  }
