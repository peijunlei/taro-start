...
export default class ReducePrice extends Component<Partial<IReducePriceProps>, T.IReducePriceState> {
  ...
  render() {
    ...
    //过滤秒杀
    marketingList = marketingList && marketingList.filter((item) => item.marketingType != 5);
    ...
    return (
      <View
        ...
        onClick={(e) => {
          e.stopPropagation();
          e.preventDefault();
          publicAction.marketingDetail(giftMarketing ? giftMarketing.marketingId : null);
        }}
      >
