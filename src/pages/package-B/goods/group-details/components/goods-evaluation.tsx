...
*/
  render() {
    ...
    const {top3Evaluate, goodsDetail} = main;
    //评价总数
    const evaluateConut = top3Evaluate?.goodsEvaluateCountResponse?.evaluateConut || 0;
    let count;
    ...
    const praise = top3Evaluate?.goodsEvaluateCountResponse?.praise || 100;
