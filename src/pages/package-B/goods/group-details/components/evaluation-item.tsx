...
*/
  render() {
    ...
    const evaluateResp = main?.top3Evaluate?.listResponse?.goodsEvaluateVOList || [];
    return (
          ...
          return (
            <View className="eval-item" id={k} key={k}>
              ...
              <View className="eval-user-info">
                <Image src={headIcon} className="head" />
                <View className="info">
                  ...
                  <View className="eval-pictures">
                    {v.evaluateImageList &&
                      v.evaluateImageList.map((item, index) => {
                        return <Image key={index} src={item.artworkUrl} className="picture" />;
                      })}
                  </View>
                </ScrollView>
              )}
