          ...
          <View className="up-content">
            <ScrollView scrollY style={{height: '100%'}}>
              ...
              {/* {((main.goodsBrands && main.goodsBrands.length > 0) ||
                (!hasNoCateFilter && main.goodsCates && main.goodsCates.length > 0)) && <View className="split-line" />} */}
              ...
              {/* 分类*/}
              {!hasNoCateFilter && main.goodsCates && main.goodsCates.length > 0 && (
                <View className="screen-box">
                  <View className="screen-titleBox">
                    <View className="screeen-title-container">
                    ...
                    {main.goodsCates &&
                      ...
                      main.goodsCates.map((item, index) => {
                        ...
                        return (
                          <View
                            className={
                              (WMkit.isMall() ? main.request.storeCateIds?.includes(item.cateId) : main.request.cateIds?.includes(item.cateId)) ? 'screen-item active-item' : 'screen-item'
                            }
                            key={index}
                            onClick={(e) => {
                              e.stopPropagation();
