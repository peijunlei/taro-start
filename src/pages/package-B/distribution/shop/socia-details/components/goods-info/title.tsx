    ...
    return (
      main && (
        <View className="title-box">
          <View className="title">{main.goodsDetail?.goods?.goodsName}</View>
          {main.goodsDetail?.goods?.goodsSubtitle && (
            <View className="sub-title">{main.goodsDetail.goods.goodsSubtitle}</View>
          )}
        </View>
      )
    );
