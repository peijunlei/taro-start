...
*/
  render() {
    ...
    // 商品标签
    let goodsLabels =
      main?.goodsDetail?.goods && main?.goodsDetail?.goods.goodsLabelList
        ? main?.goodsDetail?.goods.goodsLabelList
        : [];
    ...
    return (
      <View className="goodsInfo">
        ...
        <View className="price-collect">
          {/* 0:批发的价格 1:零售的价格 */}
          {main?.goodsDetail?.goods?.saleType == 0 ? (
        ...
        <View className="goods-label-box">
          ...
          {/* 阶梯价 折扣 */}
          {main?.goodsDetail?.goods?.priceType == 1 && (
